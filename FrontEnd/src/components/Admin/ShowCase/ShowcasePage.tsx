...
import { ImageIcon, Loader2, PlusIcon, SearchIcon } from "lucide-react";
...
export const ShowcasePage: React.FC = () => {
  ...
  const { showCases, getAllShowCases, deleteShowCase, updateShowCase, isUpdating, isLoading } = useShowCases();
